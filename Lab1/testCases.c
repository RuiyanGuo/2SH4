...
//=================Question 7================================  
    ...
    CuSuite* Lab1GetSuite() {
        ...
        SUITE_ADD_TEST(suite, TestQ1_dow);
        ...
        SUITE_ADD_TEST(suite, TestQ2_true2);
        ...
        SUITE_ADD_TEST(suite, TestQ3_add4);
        ...
        SUITE_ADD_TEST(suite, TestQ4_add);
        

        SUITE_ADD_TEST(suite, TestQ5);
        SUITE_ADD_TEST(suite, TestQ5_add);
        ...
        SUITE_ADD_TEST(suite, TestQ6_add);
        ...
        SUITE_ADD_TEST(suite, TestQ7b_add);
