...
void TestQ1_extra(CuTest *tc) {

	int n = 5;
	double input1[5] = {3.20, 4.28, 6.16, 30.00, 9.01};
	double input2[5] = {6.50, 6.00, 6.30, 8.90, 6.66};
	double actual[5];
	double expected [5] = {9.70, 10.28, 12.46, 38.90, 15.67};
	add_vectors(input1,input2,actual,n);
	int i;
	for (i=0; i<n; i++)
		CuAssertDblEquals(tc, expected[i], actual[i],0.009);
...
void TestQ2_extra(CuTest *tc) {

	int input[3][3] = {{-8, 1, 6}, {6, 8, 0}, {6, 6, 6}};
	int actual = is_diag_dom(input);
	int expected = 0;
	CuAssertIntEquals(tc, expected, actual);
}
...
void TestQ3_extra(CuTest *tc) {
	int n = 3;
	int input[3][3] = {{1, 9, 3},{ 6, 8, 9},{ 0, 3, 8}};
	int expected[9]= {1, 6, 9, 0, 8, 3, 3, 9, 8};
	int actual[9];
	diag_scan(input,actual);
...
void TestQ4_extra(CuTest *tc) {

	const char input[] = "MbMastfr UnivFrsity";
	int actual[26]={0};
	int expected[26]={1,1,0,0,0,2,0,0,2,0,0,0,2,1,0,0,0,2,2,2,1,1,0,0,1,0};
...
void TestQ5_extra(CuTest *tc) {

	const char input[] =  "MyMasterUniversity";
	char actual[20]={0};
	string_copy(input,actual,9);
	char expected[20] = "MyMaster";
	CuAssertStrEquals(tc, expected, actual);
}
//===========================================================
//=================Question 6================================   
...
void TestQ6_extra(CuTest *tc) {
	int n=8;
	int input[]={9,0,23,0,-7,0,0,44};
	int actual_output_val[8]={0};
	int actual_output_pos[8]={0};
	efficient(input,actual_output_val,actual_output_pos,n);
	int expected_output_val[8]={ 9, 23, -7, 44,0,0,0,0};
	int expected_output_pos[8]={0, 2, 4, 7,0,0,0,0};
...
CuSuite* Lab2GetSuite() {
	...
	SUITE_ADD_TEST(suite, TestQ1_extra);
