...
//=========Question 1==================================
	...
	void TestQ1_extra(CuTest *tc) {
			...
			CuAssertStrEquals(tc, "HellooWorld!", my_strcat("Helloo","World!"));
		}
...
//=================Question 3================================  
	...
	void TestQ3_readandSort1_extra(CuTest *tc) {

		char inputFile[] =  "extra.txt";
		int size;
		//create list using the input file
		char **actualList = read_words(inputFile,&size);
		sort_words(actualList,size);

		char *expectedList[]={"alonso","candy","hot","node","oscar","yoke"};
...
//===========================================================
	CuSuite* Lab3GetSuite() {
		...
		SUITE_ADD_TEST(suite, TestQ3_readandSort1_extra);
