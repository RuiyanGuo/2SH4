...
public class matrixTestAll {
	...
	@Test
	public void testConstructor1InvalidEXTRA() {
		// for constructor1
		int invalid_row1 = -100, invalid_col1 = -200;
	...
	@Test
	public void testConstructor2EXTRA() {
	  // for constructor2
    int[][] data = {{5,4,3,2,1},{6,8,8,9,0},{0,0,2,2,2},{0,0,0,9,8}};
		Matrix f = new Matrix(data);
	...
	@Test
	public void testGetElementValidEXTRA() {
	  // for constructor2
    int[][] data = {{1,2,3,4,5},{6,7,8,9,0},{0,0,1,2,3},{0,0,0,4,5}};
		Matrix f = new Matrix(data);
		
		int expected= 8;
    assertEquals(expected,f.getElement(1, 2));   
	...
	@Test
	public void testSetElementValidEXTRA() {
	  int value = 200;
	  int setvalid_row = 0, setvalid_col = 1;
    int[][] data = {{1,2,3,4,5},{6,7,8,9,0},{0,0,1,2,3},{0,0,0,4,5}};
		Matrix f = new Matrix(data);
		boolean check = f.setElement(value,setvalid_row,setvalid_col);
		String expected= "1 200 3 4 5 \n"+"6 7 8 9 0 \n"+"0 0 1 2 3 \n"+"0 0 0 4 5 \n";
    assertEquals(expected,f.toString()); 
    assertEquals(true,check);
	...
	@Test
	public void testCopyEXTRA() {

    int[][] data = {{5,4,3,2,1},{6,8,8,9,0},{0,0,2,4,3},{0,0,0,9,5}};
		Matrix origin = new Matrix(data);
    Matrix copied = origin.copy(); // make a copy
    String expected= "5 4 3 2 1 \n"+"6 8 8 9 0 \n"+"0 0 2 4 3 \n"+"0 0 0 9 5 \n";
    assertEquals(expected,copied.toString()); 
	...
	@Test
	public void testAddToValidEXTRA() {
		 int[][] add_to_data = {{6,8,5}, {1,4,0}, {0,0,-2},{3,3,0}}; // add to 'data' matrix, dimension not match
	   int[][] add_to_above = {{1,0,2}, {2,1,0}, {3,3,2},{0,-1,0}}; // add to 'add_to_data' matrix
	    

     Matrix m = new Matrix(add_to_data);
     Matrix m1 = new Matrix(add_to_above);
     
     String expected = "7 8 7 \n"+"3 5 0 \n"+"3 3 0 \n"+"3 2 0 \n";
	...
	@Test
	public void testSubMatrixInvalidEXTRA() {

    int subinvalid_row = 2, subinvalid_col = 8;
	...
	@Test
	public void testIsUpperTrTrueEXTRA() {
		//test isUpperTr()	 
    int[][] Upper1 = {{3,5,0},{0,8,9},{0,0,6},{0,0,0}};
	...
	@Test
	public void testSumValidEXTRA() {
		 Matrix[] arr2 = new Matrix[3]; // valid, can change the matrices here
		  int[][] temp1={{2,-1,2}, {1,4,-1}};
		  int[][] temp2={{1,0,-1}, {6,1,2}};
		  int[][] temp3={{0,6,-1}, {0,3,6}};
		  arr2[0] = new Matrix(temp1);
		  arr2[1] = new Matrix(temp2);
		  arr2[2] = new Matrix(temp3);
    
		 String expected ="3 5 0 \n"+"7 8 7 \n";
	...
	@Test
	public void testUpperConstructor1InvalidEXTRA() {
	...
	@Test
	public void testUpperConstructor2InvalidEXTRA() {
		int[][] notupp = {{5,0,1},{7,2,0},{3,5,0}};
		Matrix not = new Matrix(notupp);
	...
	@Test
	public void testUpperGetDimEXTRA() {
		int[][] con2_11 = {{5,4,3,2,1},{0,10,7,8,9},{0,0,6,12,12},{0,0,0,15,16},{0,0,0,0,13}};
		Matrix con2_1 = new Matrix(con2_11);
		UpperTriangularMatrix m3 = new UpperTriangularMatrix(con2_1);
		int expected=5;
		assertEquals(expected,m3.getDim());   
	...
	@Test
	public void testUpperGetElementValidEXTRA() {
	  // for constructor2
		int[][] con2_11 = {{1,2,3,4,5},{0,6,7,8,9},{0,0,10,11,12},{0,0,0,13,14},{0,0,0,0,15}};
		Matrix con2_1 = new Matrix(con2_11);
		UpperTriangularMatrix m3 = new UpperTriangularMatrix(con2_1);
		...
		int expected= 15;
		assertEquals(expected,m3.getElement(4, 4));   
	...
	@Test
	public void testUpperSetElementValidEXTRA() {
	  int value = 200;
	  int setvalid_row = 0, setvalid_col = 1;
	  int[][] con2_11 = {{1,2,3,4,5},{0,6,7,8,9},{0,0,10,11,12},{0,0,0,13,14},{0,0,0,0,15}};
	  Matrix con2_1 = new Matrix(con2_11);
	...
	@Test
	public void testUpperFullMatrixEXTRA() {

	  int[][] con2_11 = {{1,2,3,4,5,6,7},{0,8,9,10,11,12,13},{0,0,14,15,16,17,18},{0,0,0,19,20,21,22},{0,0,0,0,23,24,25},{0,0,0,0,0,26,27},{0,0,0,0,0,0,28}};
	  Matrix con2_1 = new Matrix(con2_11);
	  UpperTriangularMatrix m3 = new UpperTriangularMatrix(con2_1);
	  
	  int expected=1*8*14*19*23*26*28;
	  assertEquals(expected,m3.getDet()); 
	...
	public void testUpperEffSolveInvalid2EXTRA() {

		double []eff1 = {9,12,3,4,5};
