...
public class TestSLLAll {
	...
	@Test
	public void testSLLSetIntArrayEXTRA() {

        int[] arr = {1, 2, 5, 7, 8, 9}; // this list      
        
        SLLSet listObj2 = new SLLSet(arr);
        String expectedSet = "1, 2, 5, 7, 8, 9";
        int expectedSize = 6;
        assertEquals(expectedSize,listObj2.getSize());
        assertEquals(expectedSet,listObj2.toString());
	}
	...
	public void testCopyEXTRA() {
		...
		SLLSet copied = listObj2.copy();
        copied.add(3);
        String expectedObj2 = "1, 2, 5, 7, 8, 9";
        String expectedCopied = "1, 2, 3, 5, 7, 8, 9";
	...
	@Test
	public void testIntersection2EXTRA() {
	...
	@Test
	public void testDifference3EXTRA() {
        ...
        int[] diff2 = {1, 2, 7}; // test difference
	...
	@Test
	public void testUnionSLLSetArrayEXTRA() {
